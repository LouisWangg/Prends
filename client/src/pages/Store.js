    ...
    <Fragment>
      ...
      <div className="storeContainer">
        ...
        <p>
          ...
          <br />
          <span className="focus">KLEEXPERT</span> : layanan psikologi seperti
        ...
        <p>
          <span className="focus">KLEEDEMY</span> : layanan event seperti
          webinar, seminar, hingga workshop untuk pengembangan diri dengan
          narasumber yang kredibel.
        </p>
        <p>
          <span className="focus">KLEEMART</span> : unit produksi produk-produk
          pengembangan diri, seperti buku jurnal harian, dan kartu eksplorasi
          diri. KLEEMART sudah meluncurkan 2 series daily journal, Self
          Exploration Card, dan Exploration Card - Psychology Hacks Edition.
        </p>
        <p>
        ...
        <p>
          ...
          <bold>Exploration Card - Dating Edition</bold> yang belum diluncurkan
          secara publik.
        </p>
